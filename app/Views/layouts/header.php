...
<div class="w3-top">
    <div class="w3-bar w3-theme w3-top w3-left-align">
        ...
        <a href="/my-account" class="w3-bar-item w3-button w3-hover-white">My Account</a>
        <a href="/database-management" class="w3-bar-item w3-button w3-hover-white">Databases</a>
